...
**Output file:** `cover_letters/Shamik_Mukherjee_Cover_<company>_<role>.tex`
...
Expected output: `Output written on Shamik_Mukherjee_Cover_<company>_<role>.pdf (1 page, ...)`. Any page count other than 1 is a failure that must be fixed before presenting to the user.
...
1. Run `xelatex -interaction=nonstopmode Shamik_Mukherjee_Cover_<company>_<role>.tex`
