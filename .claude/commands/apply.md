...
### CV (`cv/Shamik_Mukherjee_CV_<company>_<role><CV_EXT>`)
...
### Cover Letter (`cover_letters/Shamik_Mukherjee_Cover_<company>_<role><COVER_EXT>`)
...
<CV_DRAFT file="cv/Shamik_Mukherjee_CV_<COMPANY>_<ROLE><CV_EXT>">
<INSERT_CV_DRAFT_HERE>
</CV_DRAFT>

<COVER_LETTER_DRAFT file="cover_letters/Shamik_Mukherjee_Cover_<COMPANY>_<ROLE><COVER_EXT>">
...
```json
{
  "file": "cv/Shamik_Mukherjee_CV_<COMPANY>_<ROLE><CV_EXT>" | "cover_letters/Shamik_Mukherjee_Cover_<COMPANY>_<ROLE><COVER_EXT>",
...
cd ../cover_letters && xelatex -interaction=nonstopmode Shamik_Mukherjee_Cover_<company>_<role>.tex
```
...
**CV (`cv/Shamik_Mukherjee_CV_<company>_<role>.pdf`):**
...
**Cover letter (`cover_letters/Shamik_Mukherjee_Cover_<company>_<role>.pdf`):**
- [ ] Exactly 1 page
...
- `cv/Shamik_Mukherjee_CV_<company>_<role><CV_EXT>`
- `cover_letters/Shamik_Mukherjee_Cover_<company>_<role><COVER_EXT>`
